...
namespace Blackbaud.UAT.Core.Crm.Dialogs
{
    ...
    /// </summary>
    public class ConstituentUpdateBatchDialog : BatchDialog
    {
        /// <summary>
        ...
        {
            {"Constituent type",new CrmField("CONSTITUENTTYPECODE", FieldType.Dropdown)},
            {"Constituent",new CrmField("PRIMARYRECORDID", FieldType.Searchlist, "ConstituentSearchbyNameorLookupID", "KEYNAME")}
