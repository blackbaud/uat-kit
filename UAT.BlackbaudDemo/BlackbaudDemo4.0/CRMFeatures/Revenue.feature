...
Scenario: Add a pledge
	...
	| Paul Simon  | $300.00 | Camp Kids Scholarship | 01/01/2015 | Monthly   | 01/01/2020  | 3                | checked             |
...
Scenario: Add a pledge with multiple designations through a batch
	...
	| System Generated Account System | Tom Brady   | $200.00 | 01/01/2015 | Pledge       | None           | Do not post    |
...
Scenario: Add a recurring gift with multiple designations through a batch
    ...
    | Joe Flacco  | $100.00 | 01/01/2015 | Recurring gift | None           |
	And split the designations
	| Designation   | Amount |
	| Library Books | $75.00 |
	| Building Fund | $25.00 |
...
Scenario: Add an enhanced revenue batch
	...
	| System Generated Account System | Eli Manning | $200.00 | 01/01/2015 | Pledge       | None           | Library Fund  | Monthly               | 01/01/2020             | 3                |
	| System Generated Account System | Eli Manning | $200.00 | 01/01/2015 | Pledge       | None           | Library Books | Monthly               | 01/01/2020             | 3                |
	Then a batch exists
	| Batch template         | Description |
...
Scenario: Split a designation in an enhanced revenue batch
	...
	| Account system                  | Constituent   | Amount  | Date       | Revenue type | Payment method | Designation   | Installment frequency | Installment start date | No. installments |
	| System Generated Account System | Rusell Wilson | $500.00 | 01/01/2015 | Pledge       | None           | Library Books | Monthly               | 01/01/2020             | 5                |
...
Scenario: Commit an enhanced revenue batch
	...
	| System Generated Account System | Drew Brees  | $500.00 | 01/01/2015 | Pledge       | None           | Library Fund | Monthly               | 01/01/2020             | 5                | Do not post    |
...
Scenario: Add a pledge with a pledge subtype though a batch
	...
	| System Generated Account System | Aaron Rodgers | $500.00 | 01/01/2015 | Pledge       | None           | Library Fund | Monthly               | 01/01/2020             | 5                | Do not post    | ERBAddPledgeWithSubtype |
	When I commit the batch
	| Batch template         | Description    |
...
Scenario: Add a donation payment with multiple designations through a batch
	...
	| Account system                  | Constituent | Amount  | Date       | Revenue type | Payment method | GL post status |
	| System Generated Account System | Cam Newton  | $200.00 | 01/01/2015 | Payment      | Cash           | Do not post    |
...
Scenario: Add a payment towards multiple commitments through a batch
	...
	| System Generated Account System | Tony Romo   | $75.00 | 01/01/2015 | Cash           | Do not post    |
