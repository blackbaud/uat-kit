...
Scenario: Edit a Constituent in a batch
	...
	| System Generated Account System | Philip Rivers | $100.00 | 01/01/2015 | Pledge       | None           | Camp Kids Scholarship | Do not post    |
	And edit the selected constituent
	| Title   | Birth date | State |
	| Admiral | 12/12/1990 | SC    |
	...
	And constituent 'Philip Rivers' has the title 'Admiral', birth date '12/12/1990' and state address 'SC'